...
@Database(entities = {BloodPressureMeasurementRecord.class, DeviceRecord.class, Measurement.class, Feature.class, LumbarExtensionTrainingMeasurementRecord.class, SampleRecord.class, SmartBearUploadDateRecord.class}, version = 39)
