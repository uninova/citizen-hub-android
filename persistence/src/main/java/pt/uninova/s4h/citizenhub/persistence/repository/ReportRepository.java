...
public class ReportRepository {
    ...
    public void getWorkTimeSimpleRecords(LocalDate localDate, Observer<List<ReportUtil>> observer){
    ...
    public void getNotWorkTimeSimpleRecords(LocalDate localDate, Observer<List<ReportUtil>> observer){
