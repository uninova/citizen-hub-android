    ...
    private void onDailySummaryUpdate(Map<MeasurementKind, MeasurementAggregate> dailySummary) {
        ...
        if (dailySummary != null) {
            ...
            if (lumbarSummary != null) {
                ...
                lumbarTextView.setText(getString(R.string.fragment_summary_text_view_lumbar_text, calculateTime(lumbarTrainingLength), lumbarScore, String.valueOf(lumbarRepetitions)));
