...
@Database(entities = {DeviceRecord.class, Measurement.class, Feature.class, LumbarExtensionTraining.class, BloodPressureRecord.class, SampleRecord.class}, version = 36, exportSchema = false)
