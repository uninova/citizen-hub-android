...
import pt.uninova.s4h.citizenhub.interoperability.Uploader;
...
public class SmartBearClient implements Uploader<DailyPostureReport> {
    ...
    @Override
    public void upload(DailyPostureReport content) {
    ...
    @Override
    public void upload(Collection<DailyPostureReport> content) {
