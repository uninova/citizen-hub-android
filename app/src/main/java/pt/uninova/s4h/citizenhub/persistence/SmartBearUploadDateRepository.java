...
public class SmartBearUploadDateRepository {
    ...
    public void obtainDaysWithData(MeasurementKind measurementKind, Observer<List<LocalDate>> observer) {
        CitizenHubDatabase.executorService().execute(() -> {
            final List<LocalDate> localDates = dao.getDaysWithValues(measurementKind);
