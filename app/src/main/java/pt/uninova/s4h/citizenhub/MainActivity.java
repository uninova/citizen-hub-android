...
public class MainActivity extends AppCompatActivity implements CitizenHubServiceBound {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appBarConfiguration =
                new AppBarConfiguration.Builder(R.id.summary_fragment, R.id.report_master_fragment,R.id.medex_fragment, R.id.device_list_fragment, R.id.logout_fragment, R.id.about_fragment)
