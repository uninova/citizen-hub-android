...
public class MeasurementProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        measurementsDbHelper = new MeasurementsDbHelper(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
                        String sortOrder) {
        SQLiteDatabase database = measurementsDbHelper.getReadableDatabase();
        Cursor cursor;
    ...
    private int updateDevice(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        SQLiteDatabase database = measurementsDbHelper.getWritableDatabase();
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case MEASUREMENTS:
                return MeasurementsContract.MeasureEntry.CONTENT_LIST_TYPE;
            case MEASUREMENTS_ID:
                return MeasurementsContract.MeasureEntry.CONTENT_ITEM_TYPE;
            default:
                throw new IllegalStateException("Unknown URI " + uri + " with match " + match);
        }
    }

    public void openAndQueryDatabase(MeasurementsDbHelper measurementsDbHelper) {
        try {
            SQLiteDatabase newDB = measurementsDbHelper.getWritableDatabase();
