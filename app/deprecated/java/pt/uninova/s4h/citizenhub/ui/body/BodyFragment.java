...
import pt.uninova.s4h.citizenhub.ui.posture.PostureViewModel;
...
public class BodyFragment extends Fragment {
    ...
    Button connect;
    Button disconnect;
    TextView body_posture_text;
    ImageView body_posture_image;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_bodyposition, container, false);
        ...
        body_posture_text = root.findViewById(R.id.textView_BP);
        body_posture_image = root.findViewById(R.id.imageView_BP);
        body_posture_text.setText("Please connect the S4H device.");
        //back_posture_image.setImageDrawaHome.ble(getResources().getDrawaHome.ble(R.drawaHome.ble.connect_device));
        body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.img_smart_shirt));
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!run_connect){
                    body_posture_text.setText("Click connect first.");
                    return;
                }
                run_start = true;
                if(Home.ble.isSensorConnected()) {
                    body_posture_text.setText("Sensor is ready, Update Position.");
                    Toast.makeText(getContext(), "Sensor connected", Toast.LENGTH_LONG).show();
                    //back_posture_image.setImageDrawaHome.ble(getResources().getDrawaHome.ble(R.drawaHome.ble.connected));
                    body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.img_smart_shirt));
                    Home.ble.startRAW();
                }
                else{
        ...
        connect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                run_start = false;
                if(Home.ble.isSensorConnected()) {
                    body_posture_text.setText("Sensor is connected, Click Start.");
                    Toast.makeText(getContext(), "Sensor connected", Toast.LENGTH_LONG).show();
                    //back_posture_image.setImageDrawaHome.ble(getResources().getDrawaHome.ble(R.drawaHome.ble.connected));
                    body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.img_smart_shirt));
                    finished = false;
    ...
    public void updateButton(View view) throws JSONException {
        ...
        if(!run_start){
            body_posture_text.setText("Click start first.");
            return;
        }
        if(Home.ble.isSensorConnected()) {
            sensor_output = Home.ble.getRAWJSON();

            body_posture_text.setText("Sensor is ready, Update Posture.");
            //Toast.makeText(getContext(), "Sensor connected", Toast.LENGTH_LONG).show();
            //body_posture_image.setImageDrawaHome.ble(getResources().getDrawaHome.ble(R.drawaHome.ble.connected));
            body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.img_smart_shirt));

            current_body_posture = sensor_output.getString("BODYPOSITION");
            //Log.i("debuga", current_body_posture + " " + sensor_output.getString("BODYPOSITION") + " " + "Ola");
            ...
            setBodyPosture(current_body_posture);
            ...
            //AppendFileAll(current_body_posture + "H " + date + "T" + "\n"); //dump to local file
            //Standing is 1, Sitting is 0
            if (current_body_posture.equals("SEATED"))
                saveData(0, "BodyPosture");
            else
                saveData(1, "BodyPosture");
            Log.i("debuga", sensor_output.toString() + " " + current_body_posture + " " + sensor_output.getString("BODYPOSITION"));
        }
        else{
            body_posture_text.setText("Please connect the S4H device.");
            //back_posture_image.setImageDrawaHome.ble(getResources().getDrawaHome.ble(R.drawaHome.ble.connect_device));
    ...
    private class AsyncCaller extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params) {
            ...
            //do your long running http tasks here,you dont want to pass argument and u can access the parent class' variaHome.ble url over here
            try {
                Thread.sleep(200);
    ...
    public void setBodyPosture(String state){
        if (state.matches("STANDING"))
        {
            body_posture_text.setText("You're Standing!");
            body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.img_standing));
        }
        else if (state.matches("SEATED"))
        {
            body_posture_text.setText("You're Sitting!");
            body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.sitting));
        }
        else
        {
            body_posture_text.setText("Please connect the S4H device.");
            //body_posture_image.setImageDrawaHome.ble(getResources().getDrawaHome.ble(R.drawaHome.ble.connect_device));
            body_posture_image.setImageDrawable(getResources().getDrawable(R.drawable.img_smart_shirt));
        }
    }
